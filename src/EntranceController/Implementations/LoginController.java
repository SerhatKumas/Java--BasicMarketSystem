...
public class LoginController implements ILoginController {
    //Boolean method that checks is there employee with the given information
    @Override
    ...
    //Boolean method that checks is there owner with the given information
    @Override
    ...
    //Boolean method that checks is there admin with the given information
    @Override
    ...
    //Login Menu Options Printing Method
    @Override
    ...
    //Login and creation of interface according to login information
    @Override
    ...
    //Method that makes connection with database and returns statement
    @Override
