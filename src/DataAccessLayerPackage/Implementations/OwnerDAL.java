...
public class OwnerDAL implements ICharacterDAL {
    ...
    //displays all owners in owner table
    @Override
    ...
    //Displays owner by owner id in owner table
    @Override
    ...
    //Displays owner by owner name in owner table
    @Override
    ...
    //Displays owner by owner ssn in owner table
    @Override
    ...
    //Deletes owner by owner id in owner table
    @Override
    ...
    //Deletes owner by owner ssn in owner table
    @Override
